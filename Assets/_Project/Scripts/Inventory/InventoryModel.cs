...
namespace Systems.Inventory
{
    public class InventoryModel
    {
        ...
        public InventoryModel(IEnumerable<ItemDetails> itemDetails, int capacity)
        {
            ...
            {
                // Debug.Log if itemDetail is null, itemDetails values, Items value
                if (itemDetail == null) Debug.Log("ItemDetail is null");
                if (itemDetails == null) Debug.Log("ItemDetails is null");
